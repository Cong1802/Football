        ...
        <div class="container overlay-content">
          <div class="d-flex justify-content-between align-items-start flex-column flex-lg-row align-items-lg-end container">
            ...
            <div class="calltoactions">
                <a href="javascript:void(0)" class="btn btn-primary btn_booking mt-2">Đặt sân</a>
            </div>
          </div>
        </div>
       </section>
...
<script>
    $('.btn_booking').click(function(){
        @if(Auth::guard('web')->user())
            location.href="{{ URL::to('/booking/'.$pitch->pitch_id) }}";
        @else
        swal({
            title: "Error",
            text: "Vui lòng đăn nhập để sử dụng chức năng này",
            icon: "warning",
            });
        @endif
    });
