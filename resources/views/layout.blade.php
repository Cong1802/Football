        ...
        <div class="container">
            ...
            <div id="Navbar">
                <ul class="nav">
                    ...
                    <li><a href="#">Bảng giá<span></span></a></li>
                ...
                <div class="row">
                    <div class="col-xs-12 col-sm-6 col-md-3 col-lg-3 footer-widget ftr-contact">
                        ...
                        <ul class="list-unstyled">
                            <li><span><i class="fa fa-map-marker"></i></span>Luxury park view</li>
                            <li><span><i class="fa fa-phone"></i></span>+00 123 4567</li>
                            <li><span><i class="fa fa-envelope"></i></span>28.Football@gmail.com</li>
                        </ul>
                    </div>
                    ...
                    <div class="col-xs-12 col-sm-6 col-md-4 col-lg-4 footer-widget ftr-about">
                        ...
                        <ul class="social-links list-inline d-flex justify-content-center list-unstyled">
            ...
            <div class="container">
                <div class="row">
                    <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6" id="copyright">
                        <p>© 2021 <a href="#">28</a>. Football Club.</p>
                    </div>
