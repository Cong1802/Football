    ...
    <div class="right_col" role="main">
        <div class="">
            <div>
                <div class="x_panel">
                    <div class="x_title">
                        <h2>Thêm mới khung giờ</small></h2>
                    ...
                    <div class="x_content">
                        ...
                        @endif
                        <form class="form-horizontal form-label-left" action="{{ URL::to('admin/insert-time-slot') }}" method="POST">
                            @csrf
                            <div class="form-group row ">
                                <label class="control-label col-md-3 col-sm-3 ">Thời gian bắt đầu</label>
                                <div class="col-md-9 col-sm-9 ">
                                    <input type="time" class="form-control" required name="time_st">
                                </div>
                            </div>
                            <div class="form-group row">
                                <label class="control-label col-md-3 col-sm-3 ">Thời gian kết thúc</label>
                                <div class="col-md-9 col-sm-9 ">
                                    <input type="time" class="form-control" required name="time_end">
                                </div>
                            </div>
                            <div class="form-group row">
                                <label class="control-label col-md-3 col-sm-3 ">Loại sân</span>
                                </label>
                                <div class="col-md-9 col-sm-9 ">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-9 col-sm-9 ">
                                    <input class="form-control" required name="price" type="number" placeholder="Giá sân ..."></input>
                                </div>
                            </div>
