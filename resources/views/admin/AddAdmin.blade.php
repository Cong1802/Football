    ...
    <div class="right_col" role="main">
        <div class="">
            <div>
                <div class="x_panel">
                    <div class="x_title">
                        <h2>Thêm tài khoản quản lý</small></h2>
                    ...
                    <div class="x_content">
                        ...
                        @endif
                        <form action="{{ URL::to('admin/insert-admin') }}" method="POST" class="form-horizontal form-label-left">
                            @csrf
                            <div class="form-group row ">
                                <label class="control-label col-md-3 col-sm-3 ">Tên quản lý </label>
                                <div class="col-md-9 col-sm-9 ">
                                    <input type="text" class="form-control" name="admin_name" placeholder="Nhập tên quản lý...">
                                </div>
                            </div>
                            <div class="form-group row">
                                <label class="control-label col-md-3 col-sm-3 ">Phone</label>
                                <div class="col-md-9 col-sm-9 ">
                                    <input type="text" class="form-control" name="admin_phone" placeholder="Nhập số điện thoại...">
                                </div>
                            </div>
                            <div class="form-group row">
